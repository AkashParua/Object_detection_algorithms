...
for i, label in enumerate(labels):
    ...
    for filename in os.listdir(label_samples_path):
        ...
        image = transform.resize(image , (32, 32)) #size of window
        samples.append(image)
        sample_labels.append(i)
        print(f'loading {image_path} done')
...
print('trainig svm classifier in progress ....')
...
with open('model_32_48.pkl' , 'wb') as f:
